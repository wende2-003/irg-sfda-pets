...
__all__ = ["load_foggy_instances", "register_foggy"]
...
def load_foggy_instances(dirname: str, split: str, class_names: Union[List[str], Tuple[str, ...]]):
    ...
    for fileid in fileids:
        ...
        # Some VOC-converted FoggyCityscape datasets store images as PNG.
...
def register_foggy(name, dirname, split, year, class_names=CLASS_NAMES):
