...
from .foggy import register_foggy
...
def register_all_foggy(root):
    SPLITS = [
        # FoggyCityscape in VOC format typically provides trainval/test splits.
        ("cityscape_2007_train_t", "foggycityscape/VOC2007", "trainval"),
        ("cityscape_2007_test_t", "foggycityscape/VOC2007", "test"),
    ]
    for name, dirname, split in SPLITS:
        year = 2007 if "2007" in name else 2012
        register_foggy(name, os.path.join(root, dirname), split, year)
...
if __name__.endswith(".builtin"):
    ...
    _root = os.getenv("DETECTRON2_DATASETS", "/root/autodl-tmp")
